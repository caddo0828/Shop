...
<script type="text/javascript" src="http://localhost:8080/Shop/static/js/login.js"></script>
</head>
<body>
<div id="header" class="wrap">
	<div id="logo"><img src="static/images/logo.gif" /></div>
	<div class="help"><a href="/Shop/register.html">注册</a><a href="#">帮助中心</a></div>
	<div class="navbar">
		<ul class="clearfix">
				...
				<table>
					...
					<tr>
						...
						<td><input class="text verycode" type="text" name="veryCode" id="randomNumberID" onfocus="FocusItem(this)" onblur="checkByItem(this);" />
							<img id="veryCode" src="/Shop/ImageServlet" />
							<a href="http://localhost:8080/Shop/login.jsp">看不清，换一张</a>
							<span></span>
						</td>
					</tr>
					<tr>
						<td><label class="ui-left"><input type="submit" name="submit"/></label></td>
						<td><label class="ui-right"><input type="button" name="register" onclick="window.location='/Shop/register.html';"/></label></td>
					</tr>
					
				</table>
				 <b style="color: red;text-align: center;" id="errID">${requestScope.err }</b>
			</form>
		</div>
	</div>
	<div class="clear"></div>
